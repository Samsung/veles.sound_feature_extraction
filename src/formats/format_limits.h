...
#define MIN_WINDOW_SAMPLES 32
#define MAX_WINDOW_SAMPLES 8096
#define DEFAULT_WINDOW_SAMPLES 512

#define DEFAULT_WINDOW_STEP 205

#define MIN_WINDOW_DURATION (1 + MIN_WINDOW_SAMPLES * 1000 / MAX_SAMPLING_RATE)
#define MAX_WINDOW_DURATION (MAX_WINDOW_SAMPLES * 1000 / MIN_SAMPLING_RATE)
#define DEFAULT_WINDOW_DURATION (DEFAULT_WINDOW_SAMPLES * 1000 \
