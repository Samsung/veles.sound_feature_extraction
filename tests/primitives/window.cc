...
TEST(Window, Rectangular) {
  ASSERT_EQ(1.0f, WindowElement(WINDOW_TYPE_RECTANGULAR, 0, 4));
  ASSERT_EQ(1.0f, WindowElement(WINDOW_TYPE_RECTANGULAR, 2, 5));
  ASSERT_EQ(1.0f, WindowElement(WINDOW_TYPE_RECTANGULAR, 8, 10));
}
...
TEST(Window, Hamming) {
  ...
  for (size_t i = 0; i < valid.size(); i++) {
    filter[i] = WindowElement(WINDOW_TYPE_HAMMING, i, 4);
  }
  for (size_t i = 0; i < valid.size(); i++) {
  ...
  for (size_t i = 0; i < valid.size(); i++) {
    filter[i] = WindowElement(WINDOW_TYPE_HAMMING, i, 5);
  }
  for (size_t i = 0; i < valid.size(); i++) {
    ASSERT_EQF(valid[i], filter[i]);
  }
  ...
  for (size_t i = 0; i < valid.size(); i++) {
    filter[i] = WindowElement(WINDOW_TYPE_HAMMING, i, 19);
  }
  for (size_t i = 0; i < valid.size(); i++) {
    ASSERT_EQF(valid[i], filter[i]);
  }
  ...
  for (size_t i = 0; i < valid.size(); i++) {
    filter[i] = WindowElement(WINDOW_TYPE_HAMMING, i, 20);
  }
  for (size_t i = 0; i < valid.size(); i++) {
    ASSERT_EQF(valid[i], filter[i]);
  }
